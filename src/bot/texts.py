...
MENU_HEADER = """🌸 Привет, {display_name}!
...
DEFAULT_ADDRESS_PUBLIC_TEMPLATE = (
    ...
    "Очаковское шоссе, 5к4, подъезд 2\n\n"
...
┣ ⏰ При опоздании больше 15 минут запись может не состояться — предупреди заранее
...
открой «Мои записи» в меню 🤍

До встречи 🌸"""

DEFAULT_REMINDER_24H_TEMPLATE = """<b>Завтра встречаемся 🌸</b>
...
DEFAULT_REMINDER_2H_TEMPLATE = """<b>Уже скоро — сегодня в <u>{time}</u></b>

💅 <b>{service}</b>

Если задержишься больше чем на 15 минут —
запись может отмениться 🤍

Если опаздываешь — нажми «⏰ Опаздываю» ниже,
я сразу передам Ангеле."""
...
DEFAULT_REPAIR_INTRO_TEMPLATE = """🛠 Ремонт и гарантия
...
BOOKING_CHOOSE_TIME_TEXT = """🕑 Теперь выбери время
...
BOOKING_SERVICE_UNAVAILABLE_TEXT = (
    "Прайс успел обновиться, и выбранная услуга больше недоступна. Показываю актуальные варианты 🤍"
)
BOOKING_PRICE_CHANGED_TEXT = (
    "Прайс успел измениться, поэтому я обновила итог. Проверь сумму ещё раз перед подтверждением 🤍"
)
...
POST_BOOKING_MENU_BUTTON_TEXT = "Главное меню"
...
REMINDER_24H_TEXT = """<b>Завтра встречаемся, {display_name} 🌸</b>
...
Всё в силе?"""
REMINDER_2H_TEXT = """<b>Уже скоро — сегодня в <u>{time}</u></b>
...
💅 {service}"""
MY_BOOKINGS_REPAIR_PHOTO_PROMPT_TEXT = """🛠 Ремонт и гарантия
...
Можно:
• сравнить обычный и rich-вариант клиентских экранов
• отправить тестовую rich-рассылку только на админов"""
ADMIN_RICH_TEST_PRICE_SENT_TEXT = "Rich-превью прайса отправила ниже ✨"
ADMIN_RICH_TEST_COMPARISON_SENT_TEXT = (
    "Сравнение «{title}» отправила ниже: сначала обычный вариант, затем rich ✨"
)
